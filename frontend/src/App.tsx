...
function App() {
  ...
  return (
    <Router>
      <div className="min-h-screen bg-pop-yellow/10 font-sans text-pop-black">
          ...
          <div className="max-w-4xl mx-auto bg-white border-4 border-pop-black shadow-hard-lg rounded-xl p-4 flex justify-between items-center relative overflow-hidden">
            ...
            <Link to="/" className="relative z-10 group flex items-center gap-2">
              <div className="bg-pop-pink border-2 border-pop-black p-2 rounded-lg shadow-hard group-hover:translate-y-1 group-hover:shadow-none transition-all">
                <img src="/logo.png" alt="GuaFi Logo" className="w-8 h-8" />
              </div>
            ...
            <div className="relative z-10 flex items-center gap-6">
              ...
              <button
                ...
                className="px-4 py-2 font-bold text-pop-black hover:bg-pop-blue hover:text-white hover:border-2 hover:border-pop-black hover:shadow-hard rounded-lg transition-all border-2 border-transparent"
              >
                {i18n.language === 'en' ? '🇨🇳' : '🇺🇸'}
              </button>
        ...
        <img
          ...
          className="fixed bottom-0 left-0 w-64 pointer-events-none z-0 mix-blend-multiply contrast-125 brightness-110 animate-[slide-up-left_1s_ease-out_forwards]"
        />
        <img
          src="/wangnima.png"
          alt="Background Asset"
          className="fixed bottom-0 right-0 w-64 pointer-events-none z-0 mix-blend-multiply contrast-125 brightness-110 animate-[slide-up-right_1s_ease-out_forwards]"
        />
